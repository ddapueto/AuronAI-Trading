"""Swing Strategy MULTI-ASSET V1 - Expansion to Tech ETFs.

Fase 1 de expansión multi-activo:
- Mantiene baseline strategy (TP 5%, 7 días, NO SL)
- Agrega ETFs sectoriales tech para diversificación
- Mismo benchmark (QQQ)
- Misma lógica de selección (relative strength)
...
class SwingMultiAssetV1:
    """
    Estrategia swing MULTI-ASSET V1.
    
    Expansión Fase 1:
    - Agrega ETFs sectoriales tech
    - Mantiene lógica baseline
    - Diversifica sin complicar
    """
    ...
    def __init__(
        ...
        """
        Inicializar estrategia swing multi-asset V1.
        ...
        logger.info(
            f"SwingMultiAssetV1 initialized: {len(symbols)} symbols "
            f"(stocks + ETFs), capital=${initial_capital}"
        )
